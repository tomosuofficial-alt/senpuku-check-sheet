...
function verifyPhotoWithAI_(base64Data, itemName, category) {
  ...
  var prompt = '飲食店（業務用厨房）の業務チェックリストの写真判定を行ってください。\n\n'
    + 'カテゴリ: ' + category + '\n'
    + 'チェック項目: ' + itemName + '\n\n'
    + 'この写真が「' + itemName + '」の作業を実施した形跡を示しているか判定してください。\n\n'
    + '【重要：業務用厨房の現実を前提に判断してください】\n'
    + '- 五徳・ガスコンロ・グリル・鉄板などの調理器具には、日常清掃では落ちない\n'
    + '  焦げ付き・炭化跡・経年変色が必ず残ります。これらは「汚れ」ではなく\n'
    + '  「機器の状態」として扱い、判定対象から除外してください。\n'
    + '- 業務用シンク・ステンレス天板の傷や水垢の痕跡、床の経年汚れも同様です。\n'
    + '- 「新品のようにピカピカ」を求めず、「清掃を実施した形跡があるか」\n'
    + '  「営業に支障のない清潔さか」で判断してください。\n'
    + '- 確信が持てない場合は OK 寄りに判定してください（やり直しのコストが高いため）。\n\n'
    + '判定基準:\n'
    + '- OK: 清掃や作業を実施した形跡が確認できる。落ちない焦げ付き・経年変色・\n'
    + '       業務使用による傷などが残っていても問題なし。\n'
    + '- NG: 明らかに作業されていない（食材カス放置・新たな油汚れがべっとり・\n'
    + '       水や液体がこぼれたまま等、清掃すれば落ちる汚れが目立つ）、\n'
    + '       または関係のない写真、作業を放棄している状態。\n\n'
